...
namespace Monster.Firebase
{
    public abstract class ControllerQueryEntityStrategy<T>
    {
        ...
        public abstract Task<IReadOnlyCollection<FirebaseObject<T>>> Newest(string limit);
        public abstract Task<IReadOnlyCollection<FirebaseObject<T>>> Oldest(string limit);
